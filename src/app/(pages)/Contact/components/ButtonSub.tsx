...
export default function ButtonSub({ text }: FancyButtonProps) {
  ...
  return (
    <button
      ...
      className="relative px-20 py-6 bg-black border border-white font-mono text-sm overflow-hidden rounded-full text-gray-50 shadow-lg cursor-pointer"
    >
      <span
        ref={textTopRef}
