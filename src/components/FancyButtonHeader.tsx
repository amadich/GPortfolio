...
export default function FancyButtonHeader({ text }: FancyButtonProps) {
  ...
  return (
    <button
      ...
      className="relative px-20 py-4 bg-white border border-white font-mono text-sm overflow-hidden rounded-full text-gray-800 shadow-lg cursor-pointer"
    >
      <span
        ref={textTopRef}
